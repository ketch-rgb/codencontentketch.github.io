...
if(isset($_POST['publish']))
{
    ...
    if($type=="image/jpeg" || $type=="image/png" || $type=="image/jpg")
    {
        ...
        {
            $_SESSION['message']="<div class='chip red black-text'> Image greater than 2MB </div>";
            header("Location: write.php");
        }
    }
    else
    {
        $_SESSION['message']="<div class='chip red black-text'> Image format not supported </div>";
        header("Location: write.php");
    }
